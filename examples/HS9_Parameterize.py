...
inputs.parameterize_cf(overwrite=False,
                      usertxt="heatsource 9 CHEHALIS FRE test",
                      name="INITIAL_MODEL",
                      inputdir=join(model_dir, "inputs", ""),
                      outputdir=join(model_dir, "outputs", ""),
                      length=11.175,
                      outputkm="all",
                      datastart="01/01/2013",
                      modelstart="06/01/2013",
                      modelend="09/30/2013",
                      dataend="12/31/2015",
                      flushdays=1,
                      offset=-7,
                      ...
                      dx=25,
                      longsample=50,
                      bcfile="fre_boundary.csv",
                      inflowsites=0,
                      inflowinfiles=None,
                      inflowkm=None,
                      accretionfile="accretion.csv",
                      metsites=4,
                      metfiles="fre_meteorology.csv",
                      metkm="0",
                      calcevap="False",
                      ...
                      calcalluvium="True",
                      alluviumtemp=12.0,
                      morphfile="fre_morphology.csv",
                      lcdatafile="fre_lc_data.csv",
                      lccodefile= None,
                      trans_count=8,
                      transsample_count=4,
